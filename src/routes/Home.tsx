...
function Home() {
  ...
  return (
    <div>
      <HomeContainer>
        <IntroBlock>
          <TradingImg src="https://preview.redd.it/22gxkq0laom41.png?width=640&crop=smart&auto=webp&s=d60a454ce4130398130120ef64bfe9c68f73a938" />
          ...
          <TextBlock>
            ...
            <FlexBox>
              <Description>
                ...
                To the Moon provides you with real-time and up-to-date
